...
<!-- Head -->
<div class="right-1 dot-small ra-node <?php if($values && $values['right-1']) echo "active-".$values['right-1'];?>"></div>
<div class="right-2 dot-small ra-node <?php if($values && $values['right-2']) echo "active-".$values['right-2'];?>"></div>
<div class="right-3 dot-small non-click ra-node <?php if($values && $values['right-3']) echo "active-".$values['right-3'];?>"></div>
...
<div class="right-11 dot-small ra-node <?php if($values && $values['right-11']) echo "active-".$values['right-11'];?>"></div>
<div class="right-12 dot-small ra-node <?php if($values && $values['right-12']) echo "active-".$values['right-12'];?>"></div>
<div class="right-13 dot-small ra-node <?php if($values && $values['right-13']) echo "active-".$values['right-13'];?>"></div>
<div class="right-14 dot-small ra-node <?php if($values && $values['right-14']) echo "active-".$values['right-14'];?>"></div>
...
<div class="right-35 dot-small ra-node <?php if($values && $values['right-35']) echo "active-".$values['right-35'];?>"></div>
<div class="right-36 dot-small ra-node <?php if($values && $values['right-36']) echo "active-".$values['right-36'];?>"></div>